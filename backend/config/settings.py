...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-=-)5x!vpx@*(i=q%)e5)_9c484^bain=1=7av)z-3siwh60$y_')

# SECURITY: Set DEBUG to False in production
DEBUG = os.environ.get('DEBUG', 'True').lower() in ('true', '1', 'yes')

# Allow hosts from environment or defaults
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,backend,nginx,frontend').split(',')
...
# Database - SQLite stored in data directory for persistence
DATABASES = {
    'default': {
